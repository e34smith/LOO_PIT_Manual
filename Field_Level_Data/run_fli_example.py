...
# @tm.python_app
def infer_model(mesh_length, eh_approx=True, oversamp=False, save_dir='./'):
    ...
    save_dir += f"/{mesh_length:d}_eh{eh_approx:d}_ovsamp{oversamp:d}"
...
if __name__ == '__main__':
    ...
    save_dir = "/Users/ethansmith/Desktop/Waterloo/Masters/LOO-PIT/loop_it_in_the_field" # Perlmutter
    for mesh_length in mesh_lengths:
        for eh_approx in eh_approxs:
            for oversamp in oversamps:
                ...
                infer_model(mesh_length, eh_approx=eh_approx, oversamp=oversamp, save_dir=save_dir)
